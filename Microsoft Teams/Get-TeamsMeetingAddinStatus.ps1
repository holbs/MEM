<#
.DESCRIPTION
    This script is deployed as a configuration item to check if Microsoft Teams Addin for Microsoft Office is in a broken state and the Teams Meeting Addin is not loading in Outlook.
    This is usually caused by some sort of upgrade issues as Teams upgrades, and is detected when the InstallSource of the Teams Meeting Addin is not the same as the Teams installation path.
    This reports compliant if Microsoft Teams Addin for Microsoft Office is installed, and the InstallSource matches the MSTeams InstallLocation
#>
